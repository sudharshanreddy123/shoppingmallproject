...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
	...
	<font color="black"><h1 align="center">Add a Product</h1></font>
		...
		<table align="center">
			...
			<tr>
				<td colspan="2"><c:if test="${!empty product.name}">
						...
						<center><input type="submit" value="<spring:message text="Add Product"/>" /><center>
					</c:if></td>
			</tr>
		</table>
	</form:form>
	...
	<font color="black"><h3 align="center"> Product List </h3></font>
